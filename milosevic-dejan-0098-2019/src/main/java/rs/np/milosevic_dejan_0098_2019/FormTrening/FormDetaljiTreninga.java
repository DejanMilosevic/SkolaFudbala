...
/**
 * Predstavlja formu koja prikazuje detalje izabranog treninga iz tabele.
 * Omogucava izmenu ili brisanje izabranog treninga.
 * 
...
public class FormDetaljiTreninga extends javax.swing.JDialog {
	...
	/**
	 * Trening ciji se detalji prikazuju na formi
	 */
	private Trening t;
	 ...
	 * @param t      trening ciji se detalji prikazuju
	 */
	...
	private void initComponents() {
		...
		cmbTeren.setModel(new javax.swing.DefaultComboBoxModel<>(
				new String[] { "Old Traford", "Camp Nou", "Marakana", "Enfild" }));
						...
						.addGroup(jPanel1Layout.createSequentialGroup()
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(jPanel1Layout.createSequentialGroup().addGap(6, 6, 6)
												.addComponent(btnOtkazi, javax.swing.GroupLayout.PREFERRED_SIZE, 172,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGap(47, 47, 47).addComponent(btnObrisi,
										...
										.addGroup(jPanel1Layout.createSequentialGroup()
												...
												.addGroup(jPanel1Layout
														.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
														.addComponent(cmbTrener, 0,
																javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
														.addComponent(cmbKategorija, 0,
																javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
														.addComponent(txtDatumVreme).addComponent(cmbTeren, 0,
																javax.swing.GroupLayout.DEFAULT_SIZE,
																Short.MAX_VALUE))))
								.addGap(8, 8, 8))
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								jPanel1Layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(
										btnIzmeni, javax.swing.GroupLayout.PREFERRED_SIZE, 184,
										javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addContainerGap())
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(78, 78, 78).addComponent(lblObavestenje)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));

		jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { btnObrisi, btnOtkazi });
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup()
						...
						.addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(lblObavestenje).addGap(18, 18, 18)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(btnOtkazi).addComponent(btnObrisi).addComponent(btnIzmeni))
	...
	private void btnObrisiActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnObrisiActionPerformed
		...
		int result = JOptionPane.showConfirmDialog(this, "Da li ste sigurni da zelite da " + "obrisete ovaj trening?",
		...
		if (result == JOptionPane.YES_OPTION) {
			try {
				...
				fp.refreshTable();
				JOptionPane.showMessageDialog(this, "Sistem je obrisao trening.", "Obavestenje",
						JOptionPane.INFORMATION_MESSAGE);
				this.dispose();
			} catch (Exception ex) {
				JOptionPane.showMessageDialog(this, "Sistem ne moze da obrise trening! " + ex.getMessage(), "Greska",
	...
	private void btnIzmeniActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnIzmeniActionPerformed
		...
		try {
			...
			FormPretragaTreninga fp = (FormPretragaTreninga) getParent();
			fp.refreshTable();
			JOptionPane.showMessageDialog(this, "Sistem je izmenio trening.", "Obavestenje",
					JOptionPane.INFORMATION_MESSAGE);
			this.dispose();

		} catch (Exception ex) {
			JOptionPane.showMessageDialog(this, "Sistem ne moze da izmeni trening! " + ex.getMessage(), "Greska",
					JOptionPane.ERROR_MESSAGE);
		}
	...
	/**
	 * Postavlja vrednosti komponenti forme na osnovu podataka o izabranom treningu.
	 * 
	 * Pri tom, ukoliko je trening vec zavrsen, odnosno datum i vreme odrzavanja je
	 * u proslosti, tada izabrani trening moze samo da se obrise, ali ne i izmeni.
	 */
